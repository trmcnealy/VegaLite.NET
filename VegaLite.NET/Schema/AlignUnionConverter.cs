...
namespace VegaLite.Schema
{
    internal class AlignUnionConverter : JsonConverter
    {
        ...
        {
            return t == typeof(AlignUnion) || t == typeof(AlignUnion?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            switch(reader.TokenType)
            {
                ...
                case JsonToken.Date:
                    ...
                    {
                        case "all":
                            return new AlignUnion
                            {
                                Enum = LayoutAlign.All
                            };
                        case "each":
                            return new AlignUnion
                            {
                                Enum = LayoutAlign.Each
                            };
                        case "none":
                            return new AlignUnion
                            {
                                Enum = LayoutAlign.None
                            };
                    }

                    break;
                case JsonToken.StartObject:
                    RowColLayoutAlign objectValue = serializer.Deserialize<RowColLayoutAlign>(reader);

                    return new AlignUnion
                    {
                        RowColLayoutAlign = objectValue
                    };
            }
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            AlignUnion value = (AlignUnion)untypedValue;

...
namespace VegaLite.Schema
{
    internal class AnchorUnionConverter : JsonConverter
    {
        ...
        {
            return t == typeof(AnchorUnion) || t == typeof(AnchorUnion?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            {
                case JsonToken.Null: return new AnchorUnion();
                ...
                case JsonToken.Date:
                    ...
                    switch(stringValue)
                    {
                        case "end":
                            ...
                            {
                                Enum = TitleAnchorEnum.End
                            };
                        case "middle":
                            return new AnchorUnion
                            {
                                Enum = TitleAnchorEnum.Middle
                            };
                        case "start":
                            return new AnchorUnion
                            {
                                Enum = TitleAnchorEnum.Start
                            };
                    }
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            AnchorUnion value = (AnchorUnion)untypedValue;

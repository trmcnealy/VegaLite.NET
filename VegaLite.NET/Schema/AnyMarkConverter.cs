...
namespace VegaLite.Schema
{
    internal class AnyMarkConverter : JsonConverter
    {
        ...
        {
            return t == typeof(AnyMark) || t == typeof(AnyMark?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            switch(reader.TokenType)
            {
                ...
                case JsonToken.StartObject:
                    BoxPlotDefClass objectValue = serializer.Deserialize<BoxPlotDefClass>(reader);

                    return new AnyMark
                    {
                        BoxPlotDefClass = objectValue
                    };
            }
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            AnyMark value = (AnyMark)untypedValue;

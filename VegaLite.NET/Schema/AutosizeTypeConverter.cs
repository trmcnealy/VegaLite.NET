...
namespace VegaLite.Schema
{
    internal class AutosizeTypeConverter : JsonConverter
    {
        ...
        {
            return t == typeof(AutosizeType) || t == typeof(AutosizeType?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "fit":   return AutosizeType.Fit;
                case "fit-x": return AutosizeType.FitX;
                case "fit-y": return AutosizeType.FitY;
                case "none":  return AutosizeType.None;
                case "pad":   return AutosizeType.Pad;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            AutosizeType value = (AutosizeType)untypedValue;

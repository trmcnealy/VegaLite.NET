...
namespace VegaLite.Schema
{
    internal class BoxPlotDefExtentConverter : JsonConverter
    {
        ...
        {
            return t == typeof(BoxPlotDefExtent) || t == typeof(BoxPlotDefExtent?);
        }
                ...
                case JsonToken.Date:
                    ...
                    switch(stringValue)
                    {
                        case "ci":
                            return new BoxPlotDefExtent
                            {
                                Enum = ExtentExtent.Ci
                            };
                        case "iqr":
                            return new BoxPlotDefExtent
                            {
                                Enum = ExtentExtent.Iqr
                            };
                        case "min-max":
                            return new BoxPlotDefExtent
                            {
                                Enum = ExtentExtent.MinMax
                            };
                        case "stderr":
                            return new BoxPlotDefExtent
                            {
                                Enum = ExtentExtent.Stderr
                            };
                        case "stdev":
                            return new BoxPlotDefExtent
                            {
                                Enum = ExtentExtent.Stdev
                            };
                    }
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            BoxPlotDefExtent value = (BoxPlotDefExtent)untypedValue;

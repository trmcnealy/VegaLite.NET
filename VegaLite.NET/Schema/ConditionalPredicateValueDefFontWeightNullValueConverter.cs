...
namespace VegaLite.Schema
{
    internal class ConditionalPredicateValueDefFontWeightNullValueConverter : JsonConverter
    {
        ...
        {
            return t == typeof(ConditionalPredicateValueDefFontWeightNullValue) || t == typeof(ConditionalPredicateValueDefFontWeightNullValue?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            {
                case JsonToken.Null: return new ConditionalPredicateValueDefFontWeightNullValue();
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            ConditionalPredicateValueDefFontWeightNullValue value = (ConditionalPredicateValueDefFontWeightNullValue)untypedValue;

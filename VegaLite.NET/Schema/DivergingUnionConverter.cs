...
namespace VegaLite.Schema
{
    internal class DivergingUnionConverter : JsonConverter
    {
        ...
        {
            return t == typeof(DivergingUnion) || t == typeof(DivergingUnion?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            switch(reader.TokenType)
            {
                ...
                case JsonToken.StartObject:
                    DivergingSignalRef objectValue = serializer.Deserialize<DivergingSignalRef>(reader);

                    return new DivergingUnion
                    {
                        DivergingSignalRef = objectValue
                    };
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            DivergingUnion value = (DivergingUnion)untypedValue;

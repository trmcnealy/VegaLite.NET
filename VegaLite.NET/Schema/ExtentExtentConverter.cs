...
namespace VegaLite.Schema
{
    internal class ExtentExtentConverter : JsonConverter
    {
        ...
        {
            return t == typeof(ExtentExtent) || t == typeof(ExtentExtent?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "ci":      return ExtentExtent.Ci;
                case "iqr":     return ExtentExtent.Iqr;
                case "min-max": return ExtentExtent.MinMax;
                case "stderr":  return ExtentExtent.Stderr;
                case "stdev":   return ExtentExtent.Stdev;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            ExtentExtent value = (ExtentExtent)untypedValue;

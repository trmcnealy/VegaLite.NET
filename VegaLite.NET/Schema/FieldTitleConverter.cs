...
namespace VegaLite.Schema
{
    internal class FieldTitleConverter : JsonConverter
    {
        ...
        {
            return t == typeof(FieldTitle) || t == typeof(FieldTitle?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "functional": return FieldTitle.Functional;
                case "plain":      return FieldTitle.Plain;
                case "verbal":     return FieldTitle.Verbal;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            FieldTitle value = (FieldTitle)untypedValue;

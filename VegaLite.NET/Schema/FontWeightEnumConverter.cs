...
namespace VegaLite.Schema
{
    internal class FontWeightEnumConverter : JsonConverter
    {
        ...
        {
            return t == typeof(FontWeightEnum) || t == typeof(FontWeightEnum?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "bold":    return FontWeightEnum.Bold;
                case "bolder":  return FontWeightEnum.Bolder;
                case "lighter": return FontWeightEnum.Lighter;
                case "normal":  return FontWeightEnum.Normal;
            }

...
namespace VegaLite.Schema
{
    internal class InterpolateUnionConverter : JsonConverter
    {
        ...
        {
            return t == typeof(InterpolateUnion) || t == typeof(InterpolateUnion?);
        }
                ...
                case JsonToken.Date:
                    ...
                    switch(stringValue)
                    {
                        case "cubehelix":
                            ...
                            {
                                Enum = ScaleInterpolate.Cubehelix
                            };
                        case "cubehelix-long":
                            return new InterpolateUnion
                            {
                                Enum = ScaleInterpolate.CubehelixLong
                            };
                        case "hcl":
                            return new InterpolateUnion
                            {
                                Enum = ScaleInterpolate.Hcl
                            };
                        case "hcl-long":
                            return new InterpolateUnion
                            {
                                Enum = ScaleInterpolate.HclLong
                            };
                        case "hsl":
                            return new InterpolateUnion
                            {
                                Enum = ScaleInterpolate.Hsl
                            };
                        case "hsl-long":
                            return new InterpolateUnion
                            {
                                Enum = ScaleInterpolate.HslLong
                            };
                        case "lab":
                            return new InterpolateUnion
                            {
                                Enum = ScaleInterpolate.Lab
                            };
                        case "rgb":
                            return new InterpolateUnion
                            {
                                Enum = ScaleInterpolate.Rgb
                            };
                    }

                    break;
                case JsonToken.StartObject:
                    ScaleInterpolateParams objectValue = serializer.Deserialize<ScaleInterpolateParams>(reader);

                    return new InterpolateUnion
                    {
                        ScaleInterpolateParams = objectValue
                    };
            }
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            InterpolateUnion value = (InterpolateUnion)untypedValue;

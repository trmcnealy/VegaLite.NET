...
namespace VegaLite.Schema
{
    internal class LabelOverlapConverter : JsonConverter
    {
        ...
        {
            return t == typeof(LabelOverlap) || t == typeof(LabelOverlap?);
        }
                ...
                case JsonToken.Date:
                    ...
                    switch(stringValue)
                    {
                        case "greedy":
                            return new LabelOverlap
                            {
                                Enum = LabelOverlapEnum.Greedy
                            };
                        case "parity":
                            return new LabelOverlap
                            {
                                Enum = LabelOverlapEnum.Parity
                            };
                    }
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            LabelOverlap value = (LabelOverlap)untypedValue;

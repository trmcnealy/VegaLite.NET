...
namespace VegaLite.Schema
{
    internal class LabelOverlapEnumConverter : JsonConverter
    {
        ...
        {
            return t == typeof(LabelOverlapEnum) || t == typeof(LabelOverlapEnum?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "greedy": return LabelOverlapEnum.Greedy;
                case "parity": return LabelOverlapEnum.Parity;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            LabelOverlapEnum value = (LabelOverlapEnum)untypedValue;

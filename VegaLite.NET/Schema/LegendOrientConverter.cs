...
namespace VegaLite.Schema
{
    internal class LegendOrientConverter : JsonConverter
    {
        ...
        {
            return t == typeof(LegendOrient) || t == typeof(LegendOrient?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "bottom":       return LegendOrient.Bottom;
                case "bottom-left":  return LegendOrient.BottomLeft;
                case "bottom-right": return LegendOrient.BottomRight;
                case "left":         return LegendOrient.Left;
                case "none":         return LegendOrient.None;
                case "right":        return LegendOrient.Right;
                case "top":          return LegendOrient.Top;
                case "top-left":     return LegendOrient.TopLeft;
                case "top-right":    return LegendOrient.TopRight;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            LegendOrient value = (LegendOrient)untypedValue;

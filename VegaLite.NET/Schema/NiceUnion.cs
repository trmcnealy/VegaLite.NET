namespace VegaLite.Schema
{
    ...
    public struct NiceUnion
    {
        ...
        public static implicit operator NiceUnion(bool @bool)
        {
            return new NiceUnion
            {
                Bool = @bool
            };
        }

        public static implicit operator NiceUnion(double @double)
        {
            return new NiceUnion
            {
                Double = @double
        ...
        public static implicit operator NiceUnion(NiceTime @enum)
        {
            return new NiceUnion
            {
                Enum = @enum
        ...
        public static implicit operator NiceUnion(NiceClass niceClass)
        {
            return new NiceUnion
            {
                NiceClass = niceClass

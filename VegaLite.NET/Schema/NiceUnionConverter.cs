...
namespace VegaLite.Schema
{
    internal class NiceUnionConverter : JsonConverter
    {
        ...
        {
            return t == typeof(NiceUnion) || t == typeof(NiceUnion?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            switch(reader.TokenType)
            {
                ...
                case JsonToken.StartObject:
                    NiceClass objectValue = serializer.Deserialize<NiceClass>(reader);

                    return new NiceUnion
                    {
                        NiceClass = objectValue
                    };
            }
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            NiceUnion value = (NiceUnion)untypedValue;

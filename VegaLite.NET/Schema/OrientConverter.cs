...
namespace VegaLite.Schema
{
    internal class OrientConverter : JsonConverter
    {
        ...
        {
            return t == typeof(Orient) || t == typeof(Orient?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "bottom": return Orient.Bottom;
                case "left":   return Orient.Left;
                case "right":  return Orient.Right;
                case "top":    return Orient.Top;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            Orient value = (Orient)untypedValue;

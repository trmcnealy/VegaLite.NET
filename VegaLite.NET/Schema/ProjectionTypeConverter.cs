...
namespace VegaLite.Schema
{
    internal class ProjectionTypeConverter : JsonConverter
    {
        ...
        {
            return t == typeof(ProjectionType) || t == typeof(ProjectionType?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "albers":               return ProjectionType.Albers;
                case "albersUsa":            return ProjectionType.AlbersUsa;
                case "azimuthalEqualArea":   return ProjectionType.AzimuthalEqualArea;
                case "azimuthalEquidistant": return ProjectionType.AzimuthalEquidistant;
                case "conicConformal":       return ProjectionType.ConicConformal;
                case "conicEqualArea":       return ProjectionType.ConicEqualArea;
                case "conicEquidistant":     return ProjectionType.ConicEquidistant;
                case "equalEarth":           return ProjectionType.EqualEarth;
                case "equirectangular":      return ProjectionType.Equirectangular;
                case "gnomonic":             return ProjectionType.Gnomonic;
                case "identity":             return ProjectionType.Identity;
                case "mercator":             return ProjectionType.Mercator;
                case "naturalEarth1":        return ProjectionType.NaturalEarth1;
                case "orthographic":         return ProjectionType.Orthographic;
                case "stereographic":        return ProjectionType.Stereographic;
                case "transverseMercator":   return ProjectionType.TransverseMercator;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            ProjectionType value = (ProjectionType)untypedValue;

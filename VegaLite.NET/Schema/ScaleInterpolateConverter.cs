...
namespace VegaLite.Schema
{
    internal class ScaleInterpolateConverter : JsonConverter
    {
        ...
        {
            return t == typeof(ScaleInterpolate) || t == typeof(ScaleInterpolate?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "cubehelix":      return ScaleInterpolate.Cubehelix;
                case "cubehelix-long": return ScaleInterpolate.CubehelixLong;
                case "hcl":            return ScaleInterpolate.Hcl;
                case "hcl-long":       return ScaleInterpolate.HclLong;
                case "hsl":            return ScaleInterpolate.Hsl;
                case "hsl-long":       return ScaleInterpolate.HslLong;
                case "lab":            return ScaleInterpolate.Lab;
                case "rgb":            return ScaleInterpolate.Rgb;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            ScaleInterpolate value = (ScaleInterpolate)untypedValue;

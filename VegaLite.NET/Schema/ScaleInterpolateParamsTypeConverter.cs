...
namespace VegaLite.Schema
{
    internal class ScaleInterpolateParamsTypeConverter : JsonConverter
    {
        ...
        {
            return t == typeof(ScaleInterpolateParamsType) || t == typeof(ScaleInterpolateParamsType?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "cubehelix":      return ScaleInterpolateParamsType.Cubehelix;
                case "cubehelix-long": return ScaleInterpolateParamsType.CubehelixLong;
                case "rgb":            return ScaleInterpolateParamsType.Rgb;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            ScaleInterpolateParamsType value = (ScaleInterpolateParamsType)untypedValue;

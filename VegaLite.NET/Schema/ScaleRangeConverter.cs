...
namespace VegaLite.Schema
{
    internal class ScaleRangeConverter : JsonConverter
    {
        ...
        {
            return t == typeof(ScaleRange) || t == typeof(ScaleRange?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            switch(reader.TokenType)
            {
                ...
                case JsonToken.StartArray:
                    List<RangeRange> arrayValue = serializer.Deserialize<List<RangeRange>>(reader);
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            ScaleRange value = (ScaleRange)untypedValue;

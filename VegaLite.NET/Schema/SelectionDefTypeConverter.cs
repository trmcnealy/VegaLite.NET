...
namespace VegaLite.Schema
{
    internal class SelectionDefTypeConverter : JsonConverter
    {
        ...
        {
            return t == typeof(SelectionDefType) || t == typeof(SelectionDefType?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "interval": return SelectionDefType.Interval;
                case "multi":    return SelectionDefType.Multi;
                case "single":   return SelectionDefType.Single;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            SelectionDefType value = (SelectionDefType)untypedValue;

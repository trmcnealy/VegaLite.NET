...
namespace VegaLite.Schema
{
    internal class SelectionLegendBindingConverter : JsonConverter
    {
        ...
        {
            return t == typeof(SelectionLegendBinding) || t == typeof(SelectionLegendBinding?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "legend": return SelectionLegendBinding.Legend;
                case "scales": return SelectionLegendBinding.Scales;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            SelectionLegendBinding value = (SelectionLegendBinding)untypedValue;

...
namespace VegaLite.Schema
{
    internal class SelectionResolutionConverter : JsonConverter
    {
        ...
        {
            return t == typeof(SelectionResolution) || t == typeof(SelectionResolution?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "global":    return SelectionResolution.Global;
                case "intersect": return SelectionResolution.Intersect;
                case "union":     return SelectionResolution.Union;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            SelectionResolution value = (SelectionResolution)untypedValue;

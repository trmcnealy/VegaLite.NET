...
namespace VegaLite.Schema
{
    internal class SortArrayConverter : JsonConverter
    {
        ...
        {
            return t == typeof(SortArray) || t == typeof(SortArray?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            {
                case JsonToken.Null: return new SortArray();
                ...
                case JsonToken.StartObject:
                    SortEncodingSortField objectValue = serializer.Deserialize<SortEncodingSortField>(reader);

                    return new SortArray
                    {
                        SortEncodingSortField = objectValue
                    };
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            SortArray value = (SortArray)untypedValue;

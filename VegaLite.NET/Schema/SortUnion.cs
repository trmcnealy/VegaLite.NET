...
namespace VegaLite.Schema
{
    ...
    public struct SortUnion
    {
        ...
        public static implicit operator SortUnion(List<Equal> anythingArray)
        {
        ...
        public static implicit operator SortUnion(EncodingSortField encodingSortField)
        {
            return new SortUnion
            {
        ...
        public static implicit operator SortUnion(Sort @enum)
        {
            return new SortUnion
            {
                Enum = @enum
        ...
        public bool IsNull { get { return AnythingArray == null && EncodingSortField == null && Enum == null; } }
    }
}

namespace VegaLite.Schema
{
    ...
    public struct Stack
    {
        ...
        public static implicit operator Stack(bool @bool)
        {
            return new Stack
            {
                Bool = @bool
        ...
        public static implicit operator Stack(StackOffset @enum)
        {
            return new Stack
            {
                Enum = @enum
        ...
        public bool IsNull { get { return Bool == null && Enum == null; } }
    }
}

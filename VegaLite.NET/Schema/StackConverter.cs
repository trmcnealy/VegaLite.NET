...
namespace VegaLite.Schema
{
    internal class StackConverter : JsonConverter
    {
        ...
        {
            return t == typeof(Stack) || t == typeof(Stack?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            {
                case JsonToken.Null: return new Stack();
                ...
                case JsonToken.Date:
                    ...
                    switch(stringValue)
                    {
                        case "center":
                            return new Stack
                            {
                                Enum = StackOffset.Center
                            };
                        case "normalize":
                            return new Stack
                            {
                                Enum = StackOffset.Normalize
                            };
                        case "zero":
                            return new Stack
                            {
                                Enum = StackOffset.Zero
                            };
                    }
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            Stack value = (Stack)untypedValue;

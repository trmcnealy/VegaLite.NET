...
namespace VegaLite.Schema
{
    internal class StackOffsetConverter : JsonConverter
    {
        ...
        {
            return t == typeof(StackOffset) || t == typeof(StackOffset?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "center":    return StackOffset.Center;
                case "normalize": return StackOffset.Normalize;
                case "zero":      return StackOffset.Zero;
            }

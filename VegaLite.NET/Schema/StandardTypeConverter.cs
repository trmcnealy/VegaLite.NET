...
namespace VegaLite.Schema
{
    internal class StandardTypeConverter : JsonConverter
    {
        ...
        {
            return t == typeof(StandardType) || t == typeof(StandardType?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "nominal":      return StandardType.Nominal;
                case "ordinal":      return StandardType.Ordinal;
                case "quantitative": return StandardType.Quantitative;
                case "temporal":     return StandardType.Temporal;
            }

...
namespace VegaLite.Schema
{
    internal class TickCountConverter : JsonConverter
    {
        ...
        {
            return t == typeof(TickCount) || t == typeof(TickCount?);
        }
                ...
                case JsonToken.Date:
                    ...
                    switch(stringValue)
                    {
                        case "day":
                            return new TickCount
                            {
                                Enum = TimeInterval.Day
                            };
                        case "hour":
                            return new TickCount
                            {
                                Enum = TimeInterval.Hour
                            };
                        case "millisecond":
                            return new TickCount
                            {
                                Enum = TimeInterval.Millisecond
                            };
                        case "minute":
                            return new TickCount
                            {
                                Enum = TimeInterval.Minute
                            };
                        case "month":
                            return new TickCount
                            {
                                Enum = TimeInterval.Month
                            };
                        case "second":
                            return new TickCount
                            {
                                Enum = TimeInterval.Second
                            };
                        case "week":
                            return new TickCount
                            {
                                Enum = TimeInterval.Week
                            };
                        case "year":
                            return new TickCount
                            {
                                Enum = TimeInterval.Year
                            };
                    }
        ...
        public override void WriteJson(JsonWriter     writer,
                                       ...
                                       JsonSerializer serializer)
        {
            TickCount value = (TickCount)untypedValue;

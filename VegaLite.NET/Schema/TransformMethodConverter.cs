...
namespace VegaLite.Schema
{
    internal class TransformMethodConverter : JsonConverter
    {
        ...
        {
            return t == typeof(TransformMethod) || t == typeof(TransformMethod?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "exp":    return TransformMethod.Exp;
                case "linear": return TransformMethod.Linear;
                case "log":    return TransformMethod.Log;
                case "max":    return TransformMethod.Max;
                case "mean":   return TransformMethod.Mean;
                case "median": return TransformMethod.Median;
                case "min":    return TransformMethod.Min;
                case "poly":   return TransformMethod.Poly;
                case "pow":    return TransformMethod.Pow;
                case "quad":   return TransformMethod.Quad;
                case "value":  return TransformMethod.Value;
            }

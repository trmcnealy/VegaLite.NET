...
namespace VegaLite.Schema
{
    internal class TypeForShapeConverter : JsonConverter
    {
        ...
        {
            return t == typeof(TypeForShape) || t == typeof(TypeForShape?);
        }
                                        ...
                                        JsonSerializer serializer)
        {
            ...
            switch(value)
            {
                case "geojson": return TypeForShape.Geojson;
                case "nominal": return TypeForShape.Nominal;
                case "ordinal": return TypeForShape.Ordinal;
            }
                                       ...
                                       JsonSerializer serializer)
        {
            ...
            TypeForShape value = (TypeForShape)untypedValue;
